...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Drupal 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://www.drupal.org/docs/user_guide/en/install-requirements.html)）：
...
* **CPU架构**: Linux x86-64, ARM 32/64, Windows x86-64, x86/i686
* **内存**: 1GB以上
* **CPU**: 1核以上
* **存储**: 20GB以上
* **Swap分区**: 2GB以上
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| drupal-server | 9001 | 浏览器访问 Drupal | Y |
## 文档

[Drupal 管理员手册](https://support.websoft9.com/docs/drupal)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Drupal 企业级支持版](https://apps.websoft9.com/drupal) 
